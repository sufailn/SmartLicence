...
// user
Future<List<Map<String, dynamic>>> getLisence() async {
  print(loginId);
  try {
    Dio dio = Dio();
    ...
    String trainerUrl = '$baseUrl/userviewliscence?adharnum=$adhar';
...
// trafic
Future<List<Map<String, dynamic>>> getLisenceTrafic(lisenceNo) async {
  print(loginId);
  try {
    Dio dio = Dio();
    ...
    // Define the URL endpoint
    // String userUrl = '$baseUrl/client/clientregistration/$loginId';
    String trainerUrl = '$baseUrl/rtoviewliscence?liscencenum=$lisenceNo';
